...
import { posts } from '../posts'; // Import dữ liệu từ file vừa tạo

// Lọc dữ liệu cho từng phần
...
<style scoped>
/* Giúp ảnh không bị méo và đồng bộ kích thước */
.main-img {
    height: 350px;
    object-fit: cover;
